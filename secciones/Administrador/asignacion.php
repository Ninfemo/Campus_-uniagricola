...
<section class="body-seccion  table-responsive-sm">
    ...
    <table class="table">
        <div class = "relleno">
            ...
            <a href="cursos.php" class="btn btn-dark b_login" onclick="history.back()">
                Volver
            </a>
        </div>
        ...
        <?php
            ...
            <td>
                <a onclick="eliminar()" class="btn btn-dark" href="asignacion.php?txtIDA=<?php echo $id; ?>&codigoCurso=<?php echo $codigoCurso?>" role="button">Eliminar</a>
            </td>
            </tr>
        <?php } ?>
        </tbody>
