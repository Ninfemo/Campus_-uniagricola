...
$sentencia = $conexion->prepare("SELECT*FROM cursos where idProfesor = :idProfesor");
$sentencia->bindParam(":idProfesor", $ID);
...
<head>
    ...
    <!--CSS-->
    <link href = "estilos/styles-usuarios.css?v=7" rel = "stylesheet">
    <!--Bootstrap-->
...
<body class = "">
  ...
  <section class="body-seccion  table-responsive-sm">
    ...
    <h1 class="center" >Bienvenido Profesor <?php echo $nombreProfesor; ?> - Tus Cursos</h1><br><br>
    <table class="table">
      <div class = "relleno">
      ...
      <tbody>
        ...
        <?php
          ...
          <tr class="text-center">
            ...
            <td>
              <a class="btn btn-primary" href="curso.php?codigoCurso=<?php echo $registro["codigo"]; ?>" role="button">Ingresar</a>

              <a class="btn btn-success" href="asignacion.php?codigoCurso=<?php echo $registro["codigo"];?>" role="button">Inscritos</a>

              <a onclick="eliminar()" class="btn btn-danger" href="index.php?txtIDA=<?php echo $registro["codigo"]; ?>" role="button"> Eliminar</a>
